                ...
                <div className="my-10 w-5/6 grid md:w-1/2 md:max-w-lg">
                    <form className="grid gap-6 m-3">
                        <div>
                            ...
                            <input required onChange={(x) => setName(x.target.value)} type="txet" className="bg-gray-100 border rounded-lg shadow-lg block w-full p-2.5" />
                        </div>
                        <div>
                        ...
                        <BottonsCreate text={"Registrar"} load={"Registrando"} name={name} password={password} api={"http://127.0.0.1:8000/api/chain"} error={"Problemas al registrar la cadena medica"}/>
                    </form>
                </div>
            </div>
