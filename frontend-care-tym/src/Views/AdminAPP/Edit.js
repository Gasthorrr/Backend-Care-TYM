                ...
                <div className="my-10 w-5/6 grid md:w-1/2 md:max-w-lg">
                    <form className="grid gap-6 m-3">
                        ...
                        <div className="grid grid-cols-2">
                            <BottonsUpdate api={"http://127.0.0.1:8000/api/chain/"} text={"Actualizar"} load={"Actualizando"} data={data} error={"Error al actualizar"} />
                            <BottonsCancel redirect={"/admin"} text={"Cancelar"}/>
                        </div>
                        <BottonsDelete api={"http://127.0.0.1:8000/api/chain/"+name} text={"Eliminar cadena medica"} load={"Eliminando"} error={"Error al eliminar la cadena"}/>
